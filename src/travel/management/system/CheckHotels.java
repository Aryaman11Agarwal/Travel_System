...
public class CheckHotels extends JFrame implements Runnable{
    ...
    public void run(){
       try{
           String text[]=new String []{"JW Mariott Hotel","Manadarin Oriental Hotel","Four Seasons Hotel","Radison Blue Hotel","Country Inn and Suites","Ramada Plaza","Classio Hotel","The Bay Club Hotel","Breeze Blow Hotel","Magnum Restaurant And Hotel"};
          for(int i=0;i<=9;i++){
